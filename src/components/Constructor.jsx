...
const Constructor = () => {
    ...
    const layoutClass = showSidePanel ? "constructor-layout split-view" : "constructor-layout centered-view";
    ...
    return (
        <div className={layoutClass}>
            <div className="constructor-main">
                ...
                <div className="constructor-election-selector" style={{
                    display: 'flex',
                    alignItems: 'center',
                    gap: '1rem',
                    marginBottom: '1rem',
                ...
                {/* Add Party */}
                <div className="constructor-add-more" style={{ marginTop: '1rem' }}>
                    <select
            ...
            {showSidePanel && (
                <div className="constructor-side-panel">
                    <SavedPredictions
                        savedList={scenarios}
                        onLoad={loadScenario}
